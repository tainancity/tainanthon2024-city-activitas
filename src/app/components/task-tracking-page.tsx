...
export const ProgressTrackingPage = () => {
  const [tasks, setTasks] = useState([
    {
      ...
      status: "進行中",
      tags: ["運動設施", "進行中"],
      details: "這是細節你知道的這是細節你知道的這是細節你知道的這是細節你知道的",
      contactRecords: [
        {
          date: "2024-09-20",
          method: "電話",
  ...
  const filteredTasks = tasks.filter(task => {
    return (
      (!filters.caseName || task.caseName?.toLowerCase().includes(filters.caseName.toLowerCase())) &&
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-muted-foreground">
          媒合中資產 <span className="text-4xl font-bold ml-2"> {tasks.length}</span>
        </div>
      </div>
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          您目前有 {todoTasks.length} 個待處理任務，{inProgressTasks.length} 個進行中任務。
          請記得定期更新您的任務卡片！
        </AlertDescription>
      </Alert>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>篩選案件, tags, 負責人, 單位, 日期等</CardDescription>
        </CardHeader>
        <CardContent>
...
value={editedTask?.assignee}
                    ...
                    <div>
                      ...
                      <Table>
                        ...
                        <TableBody>
                          {editedTask?.contactRecords?.map((record, index) => (
                            <TableRow key={index}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleNewTaskInputChange('caseName', e.target.value)}
                      />
                    </div>
                    <div>
                      <Label>負責人</Label>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => handleNewTaskInputChange('department', value)}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="選擇單位" />
                        </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleNewTaskInputChange('contact', e.target.value)}
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-4">
...
value={newTask.startDate}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleNewTaskInputChange('endDate', e.target.value)}
                      />
                    </div>
                    <div>
                      <Label>到期日</Label>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleNewTaskInputChange('details', e.target.value)}
                    />
                  </div>
                </div>
                <DialogFooter>
